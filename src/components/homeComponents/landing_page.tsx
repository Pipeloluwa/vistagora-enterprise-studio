...
export const LandingPage= () => {
    ...
    useEffect(() => {
        ...
        // Cleanup the timeout if the component unmounts or the delay changes
        ...
        <div className=" overflow-hidden lg:absolute relative lg:left-0 lg:right-0 top-[18%] lg:flex lg:items-start grid grid-rows-2 justify-center w-full h-screen"> 

            {
                ...
                <div className={`${wheelSwitchActionValue ? "animate-pulse" : "animate-none"} sm:gap-y-8 gap-y-4 lg:items-start lg:ml-12 items-center lg:absolute lg:left-0  lg:w-auto static lg:h-screen w-full flex z-20 overflow-hidden flex-col lg:mt-8`}>
                    <div className="flex lg:w-auto w-full lg:items-start items-center flex-col gap-y-4">
                    ...
                    <motion.div initial={{x:"200%"}} animate={{x:0}} transition={{duration:3, delay:3, ease:easeInOut, type:"spring", bounce: 0.2}} className='flex lg:w-auto px-2 sm:w-[50%] w-[100%] text-white lg:text-3xl sm:text-2xl text-lg'>
                    ...
                    <motion.div initial={{opacity:0, y:100}} animate={{opacity:1, y:0,}} transition={{duration:2, delay:3, ease:easeInOut, type:"spring", bounce: 0.5}} >
                    ...
                    <motion.div 
                        initial={{opacity:0, x:-100}} animate={{opacity:1, x:0,}} transition={{duration:3, delay:3, ease:easeInOut, type:"spring", bounce: 0.5}}
