                    ...
                    <AnimatePresence key={"landingPageAnimatePresence"}>
                        ...
                        <div key={"landingPageAnimatePresence1"} className="flex lg:w-auto w-full lg:items-start items-center flex-col gap-y-4">
                            <GlowCapture className='flex'>
                                <Glow color='purple' >
                                    <h1 className='z-50 bg-gradient-to-r from-[#ffffff] to-[#90c9ff] inline-block bg-clip-text text-transparent hover:from-black/0 pb-2 md:text-7xl sm:text-5xl text-4xl font-extrabold  glow:bg-black glow:text-blue-500'>
                            ...
                            <GlowCapture className='lg:ml-2 '>
                                <Glow color='purple' >
                                    <h1 className='z-50 bg-white inline-block bg-clip-text text-transparent hover:bg-black/0 md:text-5xl sm:text-3xl text-2xl font-bold glow:bg-black glow:text-blue-500'>
                                        <StaggerText  staggerType='letter' staggerDuration={1.4} >
                                            Enterprise - Studio
                                        </StaggerText>
                                    </h1>
                        ...
                        <motion.div key={"landingPageAnimatePresence2"} initial={{x:"150%"}} animate={{x:0}} transition={{duration:3, delay:3.5, ease:easeInOut, type:"spring", bounce: 0.2}} className='z-40 flex md:justify-start justify-center lg:w-auto  px-2 sm:w-[50%] w-[100%] text-white lg:text-3xl sm:text-2xl text-lg'>
                        ...
                        <motion.div key={"landingPageAnimatePresence3"} initial={{opacity:0, y:100}} animate={{opacity:1, y:0,}} transition={{duration:5, delay:3.5, ease:easeInOut, type:"spring", bounce: 0.5}} >
                            <GlowCapture className='flex w-full h-full items-center justify-center '>
                                <Glow color='purple' >
                                    <p className='z-40 lg:w-[65%] sm:max-w-[70%] w-[60%] lg:mx-0 mx-auto lg:flex-none flex lg:text-start text-center lg:text-xl md:text-md text-sm italic ease-linear translate-y-0 duration-[1500ms] text-white font-serif glow:bg-black glow:text-blue-500'>
                        ...
                        <motion.div 
                            ...
                            <Button onClick={() => {navigateAbout(navigateVar)}} className='z-40 text-lg big-button blue-pink' placeholder={""} onPointerEnterCapture={ () => {}} onPointerLeaveCapture={ () => {}}>
                                Read More
                            </Button>
                        </motion.div>
